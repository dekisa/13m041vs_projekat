...
mkdir -p ./libraries/scheduler/
mkdir -p ./libraries/rst_controller/
mkdir -p ./libraries/mm_interconnect_0/
mkdir -p ./libraries/pll_0/
mkdir -p ./libraries/ddr3_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_ddr3_0_hps.v"                  -work hps                     -cdslib ./cds_libs/hps.cds.lib                    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_vfb_0_video_in.v"   -work video_in                -cdslib ./cds_libs/video_in.cds.lib               
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_tpg_0_scheduler.sv" -work scheduler               -cdslib ./cds_libs/scheduler.cds.lib              
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_cvo_0_video_in.v"   -work video_in                -cdslib ./cds_libs/video_in.cds.lib               
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_pll_0.vo"                      -work pll_0                   -cdslib ./cds_libs/pll_0.cds.lib                  
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_ddr3_0.v"                      -work ddr3_0                  -cdslib ./cds_libs/ddr3_0.cds.lib                 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_vfb_0.v"            -work alt_vip_cl_vfb_0        -cdslib ./cds_libs/alt_vip_cl_vfb_0.cds.lib       
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_tpg_0.v"            -work alt_vip_cl_tpg_0        -cdslib ./cds_libs/alt_vip_cl_tpg_0.cds.lib       
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_cvo_0.v"            -work alt_vip_cl_cvo_0        -cdslib ./cds_libs/alt_vip_cl_cvo_0.cds.lib       
