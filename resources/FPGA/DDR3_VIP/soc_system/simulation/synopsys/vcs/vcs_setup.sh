...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_ddr3_0_hps.v \
  $QSYS_SIMDIR/submodules/altera_address_span_extender.sv \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_vfb_0_video_in.v \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_tpg_0_scheduler.sv \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_cvo_0_video_in.v \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0.v \
  $QSYS_SIMDIR/submodules/soc_system_pll_0.vo \
  $QSYS_SIMDIR/submodules/soc_system_ddr3_0.v \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_vfb_0.v \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_tpg_0.v \
  $QSYS_SIMDIR/submodules/soc_system_alt_vip_cl_cvo_0.v \
