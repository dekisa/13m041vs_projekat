...
:DownLoad
 set project.sof=DE10_Nano_Default.sof
 set project.jic=DE10_Nano_Default.jic
 set device_sfl.sof=sfl_enhanced_01_02d020dd.sof
 goto main
...
echo ===========================================================
 ...
 echo ===========================================================
 %QUARTUS_BIN%\\quartus_cpf -c -d epcs64 -s 5cseba6 %project.sof% %project.jic%
 goto end
