...
module system_mm_interconnect_0 (
		...
		input  wire [27:0] manager_data_master_address,                             //                               manager_data_master.address
		...
		input  wire [27:0] manager_instruction_master_address,                      //                        manager_instruction_master.address
	...
	wire          rsp_mux_002_src_valid;                                                         // rsp_mux_002:src_valid -> worker_0_worker_out_agent:rp_valid
	wire  [103:0] rsp_mux_002_src_data;                                                          // rsp_mux_002:src_data -> worker_0_worker_out_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                         // worker_0_worker_out_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [4:0] rsp_mux_002_src_channel;                                                       // rsp_mux_002:src_channel -> worker_0_worker_out_agent:rp_channel
	wire          rsp_mux_002_src_startofpacket;                                                 // rsp_mux_002:src_startofpacket -> worker_0_worker_out_agent:rp_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                   // rsp_mux_002:src_endofpacket -> worker_0_worker_out_agent:rp_endofpacket
	...
	wire    [4:0] cmd_mux_src_channel;                                                           // cmd_mux:src_channel -> manager_jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_002_src_channel;                                                       // cmd_mux_002:src_channel -> manager_debug_mem_slave_agent:cp_channel
	...
	wire    [4:0] cmd_mux_003_src_channel;                                                       // cmd_mux_003:src_channel -> shared_ocm_s1_agent:cp_channel
	...
	wire          manager_jtag_uart_avalon_jtag_slave_agent_rp_valid;                            // manager_jtag_uart_avalon_jtag_slave_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] manager_jtag_uart_avalon_jtag_slave_agent_rp_data;                             // manager_jtag_uart_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	wire          manager_jtag_uart_avalon_jtag_slave_agent_rp_ready;                            // router_003:sink_ready -> manager_jtag_uart_avalon_jtag_slave_agent:rp_ready
	wire          manager_jtag_uart_avalon_jtag_slave_agent_rp_startofpacket;                    // manager_jtag_uart_avalon_jtag_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          manager_jtag_uart_avalon_jtag_slave_agent_rp_endofpacket;                      // manager_jtag_uart_avalon_jtag_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [103:0] performance_counter_0_control_slave_agent_rp_data;                             // performance_counter_0_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire          manager_debug_mem_slave_agent_rp_valid;                                        // manager_debug_mem_slave_agent:rp_valid -> router_005:sink_valid
	wire  [103:0] manager_debug_mem_slave_agent_rp_data;                                         // manager_debug_mem_slave_agent:rp_data -> router_005:sink_data
	wire          manager_debug_mem_slave_agent_rp_ready;                                        // router_005:sink_ready -> manager_debug_mem_slave_agent:rp_ready
	wire          manager_debug_mem_slave_agent_rp_startofpacket;                                // manager_debug_mem_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          manager_debug_mem_slave_agent_rp_endofpacket;                                  // manager_debug_mem_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          shared_ocm_s1_agent_rp_valid;                                                  // shared_ocm_s1_agent:rp_valid -> router_006:sink_valid
	wire  [103:0] shared_ocm_s1_agent_rp_data;                                                   // shared_ocm_s1_agent:rp_data -> router_006:sink_data
	wire          shared_ocm_s1_agent_rp_ready;                                                  // router_006:sink_ready -> shared_ocm_s1_agent:rp_ready
	wire          shared_ocm_s1_agent_rp_startofpacket;                                          // shared_ocm_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          shared_ocm_s1_agent_rp_endofpacket;                                            // shared_ocm_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire    [4:0] router_src_channel;                                                            // router:src_channel -> manager_data_master_limiter:cmd_sink_channel
	...
	wire    [4:0] manager_data_master_limiter_cmd_src_channel;                                   // manager_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [4:0] rsp_mux_src_channel;                                                           // rsp_mux:src_channel -> manager_data_master_limiter:rsp_sink_channel
	...
	wire    [4:0] manager_data_master_limiter_rsp_src_channel;                                   // manager_data_master_limiter:rsp_src_channel -> manager_data_master_agent:rp_channel
	...
	wire    [4:0] router_001_src_channel;                                                        // router_001:src_channel -> manager_instruction_master_limiter:cmd_sink_channel
	...
	wire    [4:0] manager_instruction_master_limiter_cmd_src_channel;                            // manager_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                                       // rsp_mux_001:src_channel -> manager_instruction_master_limiter:rsp_sink_channel
	...
	wire    [4:0] manager_instruction_master_limiter_rsp_src_channel;                            // manager_instruction_master_limiter:rsp_src_channel -> manager_instruction_master_agent:rp_channel
	...
	wire    [4:0] cmd_demux_002_src0_channel;                                                    // cmd_demux_002:src0_channel -> cmd_mux_004:sink2_channel
	...
	wire    [4:0] rsp_demux_004_src2_channel;                                                    // rsp_demux_004:src2_channel -> rsp_mux_002:sink0_channel
	...
	wire    [4:0] router_007_src_channel;                                                        // router_007:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [4:0] manager_data_master_limiter_cmd_valid_data;                                    // manager_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [4:0] manager_instruction_master_limiter_cmd_valid_data;                             // manager_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	system_mm_interconnect_0_cmd_demux_002 rsp_demux_001 (
		.clk                (altpll_0_c0_clk),                                         //       clk.clk
		.reset              (performance_counter_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_mm_interconnect_0_cmd_demux_002 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                           //       clk.clk
		.reset              (manager_reset_reset_bridge_in_reset_reset), // clk_reset.reset
