...
# setting hal.stderr is manager_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev manager_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is manager_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev manager_jtag_uart
...
# setting hal.stdout is manager_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev manager_jtag_uart
