...
$(MEM_0)_START := 0x12000000
$(MEM_0)_END := 0x13ffffff
...
# Memory: shared_ocm
MEM_1 := system_shared_ocm
$(MEM_1)_NAME := shared_ocm
...
$(MEM_1)_START := 0x14001000
$(MEM_1)_END := 0x140011ff
$(MEM_1)_SPAN := 0x00000200
$(MEM_1)_HIERARCHICAL_PATH := shared_ocm
$(MEM_1)_WIDTH := 32
...
.PHONY: shared_ocm
shared_ocm: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
