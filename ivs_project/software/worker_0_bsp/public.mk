...
# CPU Name 
# setting CPU_NAME is worker_0_cpu
CPU_NAME = worker_0_cpu
...
# setting hal.stderr is worker_0_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev worker_0_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is worker_0_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev worker_0_jtag_uart_0
...
# setting hal.stdout is worker_0_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev worker_0_jtag_uart_0
