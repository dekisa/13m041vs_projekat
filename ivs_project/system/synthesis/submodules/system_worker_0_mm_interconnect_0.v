// system_worker_0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module system_worker_0_mm_interconnect_0 (
	...
	wire  [104:0] mm_bridge_0_s0_agent_rf_source_data;                                       // mm_bridge_0_s0_agent:rf_source_data -> mm_bridge_0_s0_agent_rsp_fifo:in_data
	...
	wire  [104:0] mm_bridge_0_s0_agent_rsp_fifo_out_data;                                    // mm_bridge_0_s0_agent_rsp_fifo:out_data -> mm_bridge_0_s0_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> mm_bridge_0_s0_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> mm_bridge_0_s0_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // mm_bridge_0_s0_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> mm_bridge_0_s0_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> mm_bridge_0_s0_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> mm_bridge_0_s0_agent:cp_endofpacket
	...
	wire          mm_bridge_0_s0_agent_rp_valid;                                             // mm_bridge_0_s0_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] mm_bridge_0_s0_agent_rp_data;                                              // mm_bridge_0_s0_agent:rp_data -> router_004:sink_data
	wire          mm_bridge_0_s0_agent_rp_ready;                                             // router_004:sink_ready -> mm_bridge_0_s0_agent:rp_ready
	wire          mm_bridge_0_s0_agent_rp_startofpacket;                                     // mm_bridge_0_s0_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          mm_bridge_0_s0_agent_rp_endofpacket;                                       // mm_bridge_0_s0_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          mm_bridge_0_s0_agent_rdata_fifo_src_valid;                                 // mm_bridge_0_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] mm_bridge_0_s0_agent_rdata_fifo_src_data;                                  // mm_bridge_0_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          mm_bridge_0_s0_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_002:in_0_ready -> mm_bridge_0_s0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> mm_bridge_0_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> mm_bridge_0_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                         // mm_bridge_0_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> mm_bridge_0_s0_agent:rdata_fifo_sink_error
	...
	system_worker_0_mm_interconnect_0_router router (
	...
	system_worker_0_mm_interconnect_0_router router_001 (
	...
	system_worker_0_mm_interconnect_0_router_002 router_002 (
	...
	system_worker_0_mm_interconnect_0_router_002 router_003 (
	...
	system_worker_0_mm_interconnect_0_router_002 router_004 (
	...
	system_worker_0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                 //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker_0_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
