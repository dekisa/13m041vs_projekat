...
(
    ...
    localparam PAD5 = log2ceil(64'h1460 - 64'h1450); 
    localparam PAD6 = log2ceil(64'h1470 - 64'h1460); 
    localparam PAD7 = log2ceil(64'h1480 - 64'h1470); 
    localparam PAD8 = log2ceil(64'h1490 - 64'h1480); 
    localparam PAD9 = log2ceil(64'h14a0 - 64'h1498); 
    localparam PAD10 = log2ceil(64'h14a4 - 64'h14a0); 
    ...
    // ( 0x1470 .. 0x1480 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h1470   ) begin
            src_channel = 19'b000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x1480 .. 0x1490 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h1480   ) begin
            src_channel = 19'b000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x1498 .. 0x14a0 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h1498   ) begin
            src_channel = 19'b000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x14a0 .. 0x14a4 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'h14a0  && read_transaction  ) begin
