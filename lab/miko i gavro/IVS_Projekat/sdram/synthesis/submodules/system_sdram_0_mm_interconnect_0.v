...
module system_sdram_0_mm_interconnect_0 (
		...
		input  wire [25:0] sdram_out_m0_address,                        //                          sdram_out_m0.address
	...
	wire  [25:0] sdram_out_m0_translator_avalon_universal_master_0_address;       // sdram_out_m0_translator:uav_address -> sdram_out_m0_agent:av_address
	...
	wire  [95:0] rsp_mux_src_data;                                                // rsp_mux:src_data -> sdram_out_m0_agent:rp_data
	...
	wire  [78:0] sdram_s1_agent_rf_source_data;                                   // sdram_s1_agent:rf_source_data -> sdram_s1_agent_rsp_fifo:in_data
	...
	wire  [78:0] sdram_s1_agent_rsp_fifo_out_data;                                // sdram_s1_agent_rsp_fifo:out_data -> sdram_s1_agent:rf_sink_data
	...
	wire  [95:0] sdram_out_m0_agent_cp_data;                                      // sdram_out_m0_agent:cp_data -> router:sink_data
	...
	wire  [77:0] sdram_s1_agent_rp_data;                                          // sdram_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [77:0] sdram_s1_burst_adapter_source0_data;                             // sdram_s1_burst_adapter:source0_data -> sdram_s1_agent:cp_data
	...
	wire  [77:0] router_001_src_data;                                             // router_001:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [95:0] sdram_s1_rsp_width_adapter_src_data;                             // sdram_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [95:0] cmd_mux_src_data;                                                // cmd_mux:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire  [77:0] sdram_s1_cmd_width_adapter_src_data;                             // sdram_s1_cmd_width_adapter:out_data -> sdram_s1_burst_adapter:sink0_data
