// system_sdram_0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module system_sdram_0_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                               //                             clk_0_clk.clk
		input  wire        sdram_out_reset_reset_bridge_in_reset_reset, // sdram_out_reset_reset_bridge_in_reset.reset
		input  wire [29:0] sdram_out_m0_address,                        //                          sdram_out_m0.address
		output wire        sdram_out_m0_waitrequest,                    //                                      .waitrequest
		input  wire [0:0]  sdram_out_m0_burstcount,                     //                                      .burstcount
		input  wire [3:0]  sdram_out_m0_byteenable,                     //                                      .byteenable
		input  wire        sdram_out_m0_read,                           //                                      .read
		output wire [31:0] sdram_out_m0_readdata,                       //                                      .readdata
		output wire        sdram_out_m0_readdatavalid,                  //                                      .readdatavalid
		input  wire        sdram_out_m0_write,                          //                                      .write
		input  wire [31:0] sdram_out_m0_writedata,                      //                                      .writedata
		input  wire        sdram_out_m0_debugaccess,                    //                                      .debugaccess
	...
	wire         sdram_out_m0_translator_avalon_universal_master_0_waitrequest;   // sdram_out_m0_agent:av_waitrequest -> sdram_out_m0_translator:uav_waitrequest
	wire  [31:0] sdram_out_m0_translator_avalon_universal_master_0_readdata;      // sdram_out_m0_agent:av_readdata -> sdram_out_m0_translator:uav_readdata
	wire         sdram_out_m0_translator_avalon_universal_master_0_debugaccess;   // sdram_out_m0_translator:uav_debugaccess -> sdram_out_m0_agent:av_debugaccess
	wire  [29:0] sdram_out_m0_translator_avalon_universal_master_0_address;       // sdram_out_m0_translator:uav_address -> sdram_out_m0_agent:av_address
	wire         sdram_out_m0_translator_avalon_universal_master_0_read;          // sdram_out_m0_translator:uav_read -> sdram_out_m0_agent:av_read
	wire   [3:0] sdram_out_m0_translator_avalon_universal_master_0_byteenable;    // sdram_out_m0_translator:uav_byteenable -> sdram_out_m0_agent:av_byteenable
	wire         sdram_out_m0_translator_avalon_universal_master_0_readdatavalid; // sdram_out_m0_agent:av_readdatavalid -> sdram_out_m0_translator:uav_readdatavalid
	wire         sdram_out_m0_translator_avalon_universal_master_0_lock;          // sdram_out_m0_translator:uav_lock -> sdram_out_m0_agent:av_lock
	wire         sdram_out_m0_translator_avalon_universal_master_0_write;         // sdram_out_m0_translator:uav_write -> sdram_out_m0_agent:av_write
	wire  [31:0] sdram_out_m0_translator_avalon_universal_master_0_writedata;     // sdram_out_m0_translator:uav_writedata -> sdram_out_m0_agent:av_writedata
	wire   [2:0] sdram_out_m0_translator_avalon_universal_master_0_burstcount;    // sdram_out_m0_translator:uav_burstcount -> sdram_out_m0_agent:av_burstcount
	wire         rsp_mux_src_valid;                                               // rsp_mux:src_valid -> sdram_out_m0_agent:rp_valid
	wire  [99:0] rsp_mux_src_data;                                                // rsp_mux:src_data -> sdram_out_m0_agent:rp_data
	wire         rsp_mux_src_ready;                                               // sdram_out_m0_agent:rp_ready -> rsp_mux:src_ready
	wire   [0:0] rsp_mux_src_channel;                                             // rsp_mux:src_channel -> sdram_out_m0_agent:rp_channel
	wire         rsp_mux_src_startofpacket;                                       // rsp_mux:src_startofpacket -> sdram_out_m0_agent:rp_startofpacket
	wire         rsp_mux_src_endofpacket;                                         // rsp_mux:src_endofpacket -> sdram_out_m0_agent:rp_endofpacket
	...
	wire  [82:0] sdram_s1_agent_rf_source_data;                                   // sdram_s1_agent:rf_source_data -> sdram_s1_agent_rsp_fifo:in_data
	...
	wire  [82:0] sdram_s1_agent_rsp_fifo_out_data;                                // sdram_s1_agent_rsp_fifo:out_data -> sdram_s1_agent:rf_sink_data
	...
	wire         sdram_out_m0_agent_cp_valid;                                     // sdram_out_m0_agent:cp_valid -> router:sink_valid
	wire  [99:0] sdram_out_m0_agent_cp_data;                                      // sdram_out_m0_agent:cp_data -> router:sink_data
	wire         sdram_out_m0_agent_cp_ready;                                     // router:sink_ready -> sdram_out_m0_agent:cp_ready
	wire         sdram_out_m0_agent_cp_startofpacket;                             // sdram_out_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire         sdram_out_m0_agent_cp_endofpacket;                               // sdram_out_m0_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire  [81:0] sdram_s1_agent_rp_data;                                          // sdram_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [81:0] sdram_s1_burst_adapter_source0_data;                             // sdram_s1_burst_adapter:source0_data -> sdram_s1_agent:cp_data
	...
	wire  [81:0] router_001_src_data;                                             // router_001:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [99:0] sdram_s1_rsp_width_adapter_src_data;                             // sdram_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [99:0] cmd_mux_src_data;                                                // cmd_mux:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire  [81:0] sdram_s1_cmd_width_adapter_src_data;                             // sdram_s1_cmd_width_adapter:out_data -> sdram_s1_burst_adapter:sink0_data
	...
	) sdram_out_m0_translator (
		.clk                    (clk_0_clk_clk),                                                   //                       clk.clk
		.reset                  (sdram_out_reset_reset_bridge_in_reset_reset),                     //                     reset.reset
		.uav_address            (sdram_out_m0_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (sdram_out_m0_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (sdram_out_m0_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (sdram_out_m0_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (sdram_out_m0_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (sdram_out_m0_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (sdram_out_m0_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (sdram_out_m0_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (sdram_out_m0_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (sdram_out_m0_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (sdram_out_m0_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (sdram_out_m0_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (sdram_out_m0_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (sdram_out_m0_burstcount),                                         //                          .burstcount
		.av_byteenable          (sdram_out_m0_byteenable),                                         //                          .byteenable
		.av_read                (sdram_out_m0_read),                                               //                          .read
		.av_readdata            (sdram_out_m0_readdata),                                           //                          .readdata
		.av_readdatavalid       (sdram_out_m0_readdatavalid),                                      //                          .readdatavalid
		.av_write               (sdram_out_m0_write),                                              //                          .write
		.av_writedata           (sdram_out_m0_writedata),                                          //                          .writedata
		.av_debugaccess         (sdram_out_m0_debugaccess),                                        //                          .debugaccess
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                                   //       clk.clk
		.reset                 (sdram_out_reset_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.av_address            (sdram_out_m0_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (sdram_out_m0_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (sdram_out_m0_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (sdram_out_m0_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (sdram_out_m0_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (sdram_out_m0_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (sdram_out_m0_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (sdram_out_m0_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (sdram_out_m0_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (sdram_out_m0_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (sdram_out_m0_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (sdram_out_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (sdram_out_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (sdram_out_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (sdram_out_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (sdram_out_m0_agent_cp_ready),                                     //          .ready
	...
	system_sdram_0_mm_interconnect_0_router router (
		.sink_ready         (sdram_out_m0_agent_cp_ready),                 //      sink.ready
		.sink_valid         (sdram_out_m0_agent_cp_valid),                 //          .valid
		.sink_data          (sdram_out_m0_agent_cp_data),                  //          .data
		.sink_startofpacket (sdram_out_m0_agent_cp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (sdram_out_m0_agent_cp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (sdram_out_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_sdram_0_mm_interconnect_0_router_001 router_001 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (sdram_out_reset_reset_bridge_in_reset_reset),  // cr0_reset.reset
	...
	system_sdram_0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (sdram_out_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_sdram_0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (sdram_out_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_sdram_0_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (sdram_out_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	system_sdram_0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (sdram_out_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_sdram_0_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (sdram_out_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
