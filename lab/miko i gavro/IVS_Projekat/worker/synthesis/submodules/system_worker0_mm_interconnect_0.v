...
module system_worker0_mm_interconnect_0 (
	...
	wire   [29:0] cpu_data_master_translator_avalon_universal_master_0_address;              // cpu_data_master_translator:uav_address -> cpu_data_master_agent:av_address
	...
	wire   [29:0] cpu_instruction_master_translator_avalon_universal_master_0_address;       // cpu_instruction_master_translator:uav_address -> cpu_instruction_master_agent:av_address
	...
	wire   [29:0] cpu_debug_mem_slave_agent_m0_address;                                      // cpu_debug_mem_slave_agent:m0_address -> cpu_debug_mem_slave_translator:uav_address
	...
	wire   [29:0] worker_out_s0_agent_m0_address;                                            // worker_out_s0_agent:m0_address -> worker_out_s0_translator:uav_address
	...
	wire  [104:0] worker_out_s0_agent_rf_source_data;                                        // worker_out_s0_agent:rf_source_data -> worker_out_s0_agent_rsp_fifo:in_data
	...
	wire  [104:0] worker_out_s0_agent_rsp_fifo_out_data;                                     // worker_out_s0_agent_rsp_fifo:out_data -> worker_out_s0_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> worker_out_s0_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // worker_out_s0_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> worker_out_s0_agent:cp_channel
	...
	wire  [103:0] worker_out_s0_agent_rp_data;                                               // worker_out_s0_agent:rp_data -> router_004:sink_data
	...
	wire    [2:0] router_src_channel;                                                        // router:src_channel -> cpu_data_master_limiter:cmd_sink_channel
	...
	wire    [2:0] cpu_data_master_limiter_cmd_src_channel;                                   // cpu_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [2:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_data_master_limiter:rsp_sink_channel
	...
	wire    [2:0] cpu_data_master_limiter_rsp_src_channel;                                   // cpu_data_master_limiter:rsp_src_channel -> cpu_data_master_agent:rp_channel
	...
	wire    [2:0] router_001_src_channel;                                                    // router_001:src_channel -> cpu_instruction_master_limiter:cmd_sink_channel
	...
	wire    [2:0] cpu_instruction_master_limiter_cmd_src_channel;                            // cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [2:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> cpu_instruction_master_limiter:rsp_sink_channel
	...
	wire    [2:0] cpu_instruction_master_limiter_rsp_src_channel;                            // cpu_instruction_master_limiter:rsp_src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire    [2:0] cpu_data_master_limiter_cmd_valid_data;                                    // cpu_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [2:0] cpu_instruction_master_limiter_cmd_valid_data;                             // cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	system_worker0_mm_interconnect_0_router router_001 (
	...
	system_worker0_mm_interconnect_0_router_002 router_004 (
	...
	system_worker0_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	system_worker0_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker0_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_worker0_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
